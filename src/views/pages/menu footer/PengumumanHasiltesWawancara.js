...
function PengumumanHasiltesWawancara() {
  return (
    <>
      <Navbar />
          ...
          <div className="row">
            <div className="col-lg-8">
              <h1 style={{ fontWeight: "bold", fontSize: "45px" }}>
                Pengumuman Tes Wawancara Seleksi Calon Anggota Bawaslu Kab/Kota
                2023 Provinsi Jawa Tengah Zona III
              </h1>
              <div className="row">
                <div className="">
                  <p>
                    <i className="fa-regular fa-user"></i> by Bawaslu Boyolali - 16
                    Agustus 2023
                  </p>
                </div>
                <div className="">
              ...
              <div className="single-blog-inner">
                ...
                <div className="thumb">
                  <img
                    style={{ height: "450px" }}
                    src="https://boyolali.bawaslu.go.id/cepogo/2023/09/20230716035010.jpg"
                    alt="img"
                  />
                </div>
              ...
              <div className="jnews_inline_related_post">
                ...
                <hr />
                <p>Silahkan donwload pengumuman melalui link di bawah ini.</p>
              </div>
            </div>
...
export default PengumumanHasiltesWawancara;
