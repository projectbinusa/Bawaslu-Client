...
function PengumumanHasilSeleksi() {
  return (
    <>
      <Navbar />
          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <div className="row">
                <div className="">
                  <p>
                    <i className="fa-regular fa-user"></i> by Bawaslu Boyolali - 27
                    Juni 2023
                  </p>
                </div>
                <div className="">
              ...
              <div className="single-blog-inner">
                ...
                <div className="thumb">
                  <img
                    style={{ height: "450px" }}
                    src="PENGUMUMAN HASIL SELEKSI ADMINISTRASI BAKAL CALON ANGGOTA BAWASLU KABUPATEN/KOTA 2023-2028 ZONA III"
                    alt="img"
                  />
                </div>
                ...
                <p>
                  Pengumuman hasil seleksi administrasi Bakal Calon Anggota
                  Bawaslu Kabupaten/Kota Periode 2023-2028 Zona III.
                </p>
              </div>
...
export default PengumumanHasilSeleksi;
