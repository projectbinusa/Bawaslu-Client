...
function PengumumanTesTertulis() {
  return (
    <>
      <Navbar />
          ...
          <div className="row">
            <div className="col-lg-8">
              <h1 style={{ fontWeight: "bold", fontSize: "45px" }}>
                Pengumuman Hasil Tes Tertulis dan Tes Psikologi Calon Anggota
                Bawaslu Kab/Kota Provinsi Jawa Tengah Zona III
              </h1>
              <div className="row">
                <div className="">
                  <p>
                    <i className="fa-regular fa-user"></i> by Bawaslu Boyolali - 14
                    Agustus 2023
                  </p>
                </div>
                <div className="">
              ...
              <div className="single-blog-inner">
                ...
                <div className="thumb">
                  <img
                    style={{ height: "450px" }}
                    src="https://boyolali.bawaslu.go.id/cepogo/2023/09/20230714121845.jpg"
                    alt="img"
                  />
                </div>
              ...
              <div className="jnews_inline_related_post">
                ...
                <hr />
                <p>Selengkapnya, silahkan download pada link di bawah ini.</p>
              </div>
            </div>
...
export default PengumumanTesTertulis;
