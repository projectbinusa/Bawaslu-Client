          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <div className="row">
                <div className="">
                  <p>
                    <i className="fa-regular fa-user"></i> by Humas Bawaslu Boyolali
                    - 23 Oktober 2023
                  </p>
                </div>
                <div className="">
          ...
          <div className="col-3">
            <p>All</p>
              ...
              <div className="single-blog-inner">
                ...
                <p>
                  Boyolali – Panwaslu Kecamatan Tamansari mengadakan Sosialisasi
                  Pengawasan Partisipatif kepada masyarakat Dk. Tritis, Ds.
                  Jemowo, Kec. Tamansari pada hari Minggu, 22 Oktober 2023 dalam
                  acara HUT Pemuda/Pemudi BSA.
                </p>
              </div>
              ...
              <h4 className="pt-4 mb-4">Related Posts</h4>
                ...
                <hr />
                <p>
                  Dalam kegiatan tersebut juga dihadiri oleh Pengawas Desa
                  Jemowo dan warga masyarakat Dk.Tritis yg berjumlah sekitar 200
                  orang.
                </p>
                <p>
                  Dalam sosialisasinya, Ketua Panwaslu Kecamatam Tamansari,
                  Soleh Santoso mengajak kepada semua warga untuk memastikan
                  seluruh warga yang hadir sudah terdaftar di DPT online dan
                  melaporkan kepada Panwaslu Kecamatan apabila ada yang belum
                  terdaftar dalam DPT.
                </p>
                <p>
                  Soleh menambahkan, agar Pemuda/Pemudi ikut berperan aktif
                  dalam mengawasi pemilu tahun 2024 dan melaporkan setiap ada
                  pelanggaran pemilu kepada Panwaslu Kecamatan Tamansari agar
                  tercipta pemilu yg berintegritas dan bermartabat.
                </p>
                <p>
                  Peran Pemuda sangat penting dalam pelaksanaan Pesta Demokrasi,
                  sesuai dengan asas Pemilu yang tertuang dalam UU Pemilu no 7
                  Tahun 2017, yaitu pemilu dilaksakan secara Langsung, Umum,
                  Bebas, Rahasia, Jujur dan Adil, tambah Soleh.
                </p>
                <p>
                  Kegiatan tersebut diahiri dengan pembagian door prize dan
                  pemotongan tumpeng sebagai wujud syukur kepada Tuhan Yang Maha
                  Esa.
                </p>
              </div>
            </div>
...
export default PemiluBermartabat;
