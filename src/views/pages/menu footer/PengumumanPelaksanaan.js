...
function PengumumanPelaksanaan() {
  return (
    <>
      <Navbar />
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8">
              ...
              Pengumuman Pelaksanaan Test Psikologi Calon Anggota Bawaslu Kabupaten/Kota Provinsi Jawa Tengah Zona III
              </h1>
              <div className="row">
                <div className="">
                  <p>
                    <i className="fa-regular fa-user"></i> by Bawaslu Boyolali - 29
                    Juni 2023
                  </p>
                </div>
                <div className="">
              ...
              <div className="single-blog-inner">
                ...
                <div className="thumb">
                  <img
                    style={{ height: "450px" }}
                    src="https://boyolali.bawaslu.go.id/cepogo/2023/09/20230629102618.jpg"
                    alt="img"
                  />
                </div>
...
export default PengumumanPelaksanaan;
