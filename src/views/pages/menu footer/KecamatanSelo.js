          ...
          <div className="row">
            <div className="col-lg-8">
              <h1 style={{ fontWeight: "bold", fontSize: "45px" }}>
                Bawaslu Boyolali Lakukan Supervisi Pemutakhiran Data Pemilih ke
                Kecamatan Selo{" "}
              </h1>
              <div className="row">
                <div className="">
                  <p>
                    <i className="fa-regular fa-user"></i> by Bawaslu Boyolali - 12
                    Juli 2023
                  </p>
                </div>
                <div className="">
              ...
              <div className="single-blog-inner">
                ...
                <div className="thumb">
                  <img
                    style={{ height: "450px" }}
                    src="https://boyolali.bawaslu.go.id/cepogo/2023/09/20230712020853.jpeg"
                    alt="img"
                  />
                </div>
                ...
                <p>
                  Boyolali -Pemutakhiran data pemilih selalu menjadi salah satu
                  tahapan yang banyak diperbincangkan di setiap pemilu. Adalah
                  wajar mengingat data pemilih erat kaitannya dengan tahapan
                  lain di pemilu seperti logistik, TPS.Rabu (12/7) Bawaslu
                  Boyolali melakukan supervisi pemutakhiran data pemilih ke
                  Panwaslu Kecamatan Selo. .
                </p>
              </div>
              ...
              <h4 className="pt-4 mb-4">Related Posts</h4>
                ...
                <hr />
                <p>
                  Pada supervisi kali ini, Panwaslu Kecamatan Selo mengundang
                  seluruh PKD untuk ikut hadir dan berdiskusi menyampaikan
                  kendala-kendala yang ada di lapangan. Rubianto selaku
                  Koordinator Divisi Hukum, Pencegahan, Partisipasi Masyarakat
                  dan Humas memberikan penguatan kapasitas kepada PKD se
                  Kecamatan Selo agar di masa tahapan selanjutnya hingga tahapan
                  berakhir terus bekerja sesuai kapasitas dan wewenangnya.
                </p>
              </div>
            </div>
