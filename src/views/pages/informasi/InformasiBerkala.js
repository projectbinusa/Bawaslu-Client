...
function InformasiBerkala() {
  ...
  const getByMenu1 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/menu-regulasi/get-by-jenis-regulasi?id-jenis-regulasi=5`
      )
      .then((response) => {
        // console.log(response.data.data);
  ...
  const getByIsi7 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=19`
      )
      .then((response) => {
        // console.log(response.data.data);
  ...
  const getByIsi8 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=20`
      )
      .then((response) => {
        // console.log(response.data.data);
  ...
  const getByIsi9 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=24`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi9(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi10 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=25`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi10(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi11 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=26`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi11(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi12 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=27`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi12(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi13 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=28`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi13(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi14 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=29`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi14(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi15 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=30`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi15(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi16 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=31`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi16(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi17 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=32`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi17(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi18 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=33`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi18(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi19 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=34`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi19(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi20 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=37`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi20(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi21 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=38`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi21(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi22 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=39`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi22(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
  ...
  const getByIsi23 = async () => {
    await axios
      .get(
        `http://localhost:3030/bawaslu/api/regulasi/get-by-menu-regulasi?id-menu-regulasi=40`
      )
      .then((response) => {
        // console.log(response.data.data);
        setIsi23(response.data.data);
      })
      .catch((error) => {
        alert("Terjadi kesalahan" + error);
      });
