              ...
              <tbody>
                <tr>
                  <td data-cell="dokumen" scope="row">
                    <p>
                      SK PENETAPAN DAN DIP BAWASLU KABUPATEN BOYOLALI TAHUN 2020
                      PERIODE I
                    </p>
                  </td>
                  <td>
                ...
                <tr>
                  <td data-cell="unduh">
                    <p>
                      {" "}
                      SK PENETAPAN DAN DIP BAWASLU KABUPATEN BOYOLALI TAHUN 2021
                      PERIODE I
                    </p>
                  </td>{" "}
                  <td>
                ...
                <tr>
                  <td data-cell="unduh">
                    <p>
                      {" "}
                      SK PENETAPAN DAN DIP BAWASLU KABUPATEN BOYOLALI TAHUN 2022
                      PERIODE I
                    </p>
                  </td>{" "}
                  <td>
                ...
                <tr>
                  <td data-cell="unduh">
                    <p>
                      {" "}
                      SK PENETAPAN DAN DIP BAWASLU KABUPATEN BOYOLALI TAHUN 2023
                      PERIODE I
                    </p>
                  </td>{" "}
                  <td>
